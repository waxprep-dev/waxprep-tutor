...
export const TOOLS: ToolDefinition[] = [
  ...
  },
  {
    ...
    function: {
      ...
      parameters: {
        ...
        properties: {
          body: { type: "string" },
          options: { type: "array", minItems: 2, maxItems: 3, items: { type: "object", properties: { id: { type: "string" }, title: { type: "string" } }, required: ["id", "title"] } },
          footer: { type: "string" },
        },
  ...
  },
  {
    ...
    function: {
      ...
      parameters: {
        ...
        properties: {
          prompt: { type: "string" },
          sections: { type: "array", items: { type: "object", properties: { title: { type: "string" }, topics: { type: "array", items: { type: "object", properties: { id: { type: "string" }, title: { type: "string" }, description: { type: "string" } } } } } } },
        },
  ...
  },
  {
    ...
    function: {
      ...
      parameters: {
        type: "object",
        properties: { name: { type: "string" }, subject: { type: "string" }, description: { type: "string" }, concept_id: { type: "string" } },
  ...
  },
  {
    ...
    function: {
      ...
      parameters: {
        type: "object",
        properties: { prompt: { type: "string" }, concept_id: { type: "string" } },
