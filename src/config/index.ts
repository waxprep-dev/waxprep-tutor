...
export const config: Config = {
  meta: {
    ...
    verifyToken: getEnvVar('META_VERIFY_TOKEN')!,
    phoneNumberId: getEnvVar('META_PHONE_NUMBER_ID')!,
    accessToken: getEnvVar('META_ACCESS_TOKEN')!,
  },
  redis: {
...
export function validateConfig(): void {
  ...
  if (!config.meta.verifyToken) {
    throw new Error('META_VERIFY_TOKEN is required');
  }
